...
export function SuspendOrganization({
  ...
  // Confirmation par saisie exacte du slug (maquette ecran 11).
      ...
      <div className="mt-3 flex flex-wrap items-start justify-between gap-4">
        ...
        <Modal open={open} onOpenChange={handleOpenChange}>
          ...
          <ModalContent size="md">
            <ModalHeader>
              <ModalTitle>Suspendre « {name} » ?</ModalTitle>
              <ModalDescription>
            ...
            <ModalFooter>
              ...
              {/* Desactive tant que la saisie ne correspond pas exactement. */}
              <Button
                variant="danger"
                disabled={!matches}
                onClick={() => {
